...
""", end="")
  ...
  if index_mode == "annot":
    ...
    P('<form method="get" action="{}" name="search_form" onsubmit="check_search_form()">',
      script_name)
    P('<div id="query_line">')
